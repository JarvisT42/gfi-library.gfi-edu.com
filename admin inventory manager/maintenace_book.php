...
details such as ISBN, Department, Subject, Volume, and Edition, ensuring accurate and organized book records for streamlined management and easy access.              
   ...
   <a href="maintenace_edit_book.php?id=${record.id}&table=${record.table}" class="text-blue-600 hover:underline">
    Edit Book
</a>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const dropdownRequest = document.getElementById('dropdown-maintenance');
