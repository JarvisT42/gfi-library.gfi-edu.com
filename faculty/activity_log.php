...
$stmt->bind_param('si', $today, $facultyId);
                        ...
                        <div id="table2" class="overflow-x-auto">
                            <div class="scrollable-table-container pt-2 pr-6 pb-2 pl-4 sm:rounded-lg border border-gray-300">
                                ...
                                <div class="scrollable-table-container">
                                    ...
                                    $categoryQueryReturned = "SELECT Category, book_id, Issued_Date, Return_Date, total_fines, status FROM borrow WHERE faculty_id = ? AND (status = 'returned' OR status = 'failed-to-claim2' OR status = 'replaced' OR status = 'lost-pay') ORDER BY Return_Date DESC";
