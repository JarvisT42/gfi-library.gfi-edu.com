...
if ($table === 'All fields') {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_array()) {
            ...
            $sql = "SELECT id, Call_Number, title, author, volume, edition, Date_Of_Publication_Copyright, No_Of_Copies, image_path FROM `$tableName` where archive !='yes' ";
    ...
    $sql = "SELECT id, Call_Number, title, author, volume, edition, Date_Of_Publication_Copyright, No_Of_Copies, image_path FROM `$table` where archive !='yes' ";
