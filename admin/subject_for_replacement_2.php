                            ...
                            <form id="accessionNumbersForm" class="space-y-4" method="POST">
                                <div class="grid grid-cols-3 items-start  ">
                                    ...
                                    <div class="col-span-2 border rounded px-3 py-2 bg-gray-50 space-y-2">
                                        ...
                                        $accession_sql = "SELECT accession_no, available FROM accession_records WHERE book_id = ? AND book_category = ? AND status = 'subject-for-replacement'";
                                        ...
                                        if ($accession_stmt) {
                                            ...
                                            if ($accession_result->num_rows > 0) {
                                                ...
                                                while ($accession_row = $accession_result->fetch_assoc()) {
                                                    ...
                                                    $is_available = htmlspecialchars($accession_row['available']) === 'yes' ? 'checked' : '';
