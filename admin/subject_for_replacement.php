                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            function loadTableData(tableName) {
                                fetch(`subject_for_replacement_fetch_data.php?table=${encodeURIComponent(tableName)}`)
    ...
    `).join('');
                    ...
                    `;
                            ...
                            function redirectToArchive(bookId, category) {
                                ...
                                window.location.href = `subject_for_replacement_2.php?id=${bookId}&table=${encodeURIComponent(category)}`;
